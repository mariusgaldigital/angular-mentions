...
export declare class MentionDirective implements OnChanges {
    ...
    keyPressHandler(event: any, nativeElement?: HTMLInputElement): void;
    keyDownHandler(event: any, nativeElement?: HTMLInputElement): boolean;
    stopSearch(): void;
    updateSearchList(): void;
    showSearchList(nativeElement: HTMLInputElement): void;
    private extractCharPressed;
}
